...
// Ambil daftar mata kuliah milik guru
...
<div class="col-md-9 ms-sm-auto col-lg-10 p-4">
  ...
  <div class="mb-3 text-end">
    <a href="create.php" class="btn btn-success">
      <i class="bi bi-plus-circle-fill me-1"></i>Tambah Mata Kuliah
    </a>
  </div>
  ...
  <div class="card shadow border-0">
    <div class="card-body p-0">
      <table class="table table-striped align-middle mb-0">
        ...
        <tbody>
          <?php if ($courses->num_rows > 0): $no = 1; while($c = $courses->fetch_assoc()): ?>
          <tr>
            <td><?= $no++ ?></td>
            ...
            <td>
              ...
              <a href="delete.php?id=<?= $c['id'] ?>" 
                 ...
                 onclick="return confirm('Yakin ingin menghapus mata kuliah ini beserta semua tugas dan pengumpulannya?')">
          ...
          <?php endwhile; else: ?>
          <tr>
            <td colspan="5" class="text-center text-muted py-4">Belum ada mata kuliah</td>
          </tr>
          <?php endif; ?>
        </tbody>
      </table>
